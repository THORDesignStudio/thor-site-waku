                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-fluid-xl leading-relaxed">
                      ...
                      fluid-xl text that scales smoothly from 20px to 24px as
                      your viewport grows.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-fluid-lg leading-relaxed">
                      The quick brown fox jumps over the lazy dog. This is
                      fluid-lg text that scales smoothly from 18px to 20px as
                      your viewport grows.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-fluid-sm leading-normal">
                      The quick brown fox jumps over the lazy dog. This is
                      fluid-sm text that scales smoothly from 14px to 16px as
                      your viewport grows.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-fluid-xs leading-normal">
                      The quick brown fox jumps over the lazy dog. This is
                      fluid-xs text that scales smoothly from 12px to 14px as
                      your viewport grows.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-20 px-6 bg-cream">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="body-lg text-night/70 mb-12 max-w-3xl">
              Our color system is built on a vibrant gradient that flows from
              deep blues through purples to energetic pinks. Each color is
              defined as a CSS variable for consistency across the entire design
              system.
            </p>
            ...
            <div className="space-y-12">
              ...
              <div className="bg-white rounded-2xl p-8">
                ...
                <p className="body-lg mb-4">
                  ...
                  paragraphs or emphasized content that needs a bit more
                  presence than regular body copy.
                </p>
                <code className="text-fluid-xs bg-cream px-3 py-1 rounded">
